...
class ExercisesTest < ApplicationSystemTestCase
  ...
  test "creating a Exercise" do
    ...
    fill_in "Discription", with: @exercise.discription
    fill_in "Equipment", with: @exercise.equipment
    fill_in "Minute", with: @exercise.minute
    fill_in "Name", with: @exercise.name
    fill_in "Targetareas", with: @exercise.targetareas
